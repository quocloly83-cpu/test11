  ...
  <style>
    ...
    *{font-family:"Alata", Arial, sans-serif}
    ...
    .top::before{
      ...
      background:radial-gradient(circle, rgba(201,176,122,.12), transparent 65%);
      pointer-events:none
    }
    .top::after{
    ...
    .btn{
      ...
      background:linear-gradient(90deg,#585d66,#ad9361,#ebe2cf);
    ...
    .tab.active{background:linear-gradient(90deg,#5b6068,#987f58,#d3c09a)}
    ...
    .loadingBar > span{
      ...
      background:linear-gradient(90deg,#5f636c,#ae9462,#e6dcc7);
    ...
    .fxMeter:before{content:"";position:absolute;inset:0;width:72%;background:linear-gradient(90deg,#8b9099,#c7a96d);animation:meterRun 2s linear infinite}
    ...
    .fxMeter:before{background:linear-gradient(90deg,#8c8698,#d6c49a,#f2ede1)}
